...
# Volumetric densities per cubic micron of synapses and excitatory percentage by layer - see 'plot_synapse_density_and_ei_ratio.py' for derivation

e_density_per_cubic_micron = {
    'white_matter': 0.030781175508420525, 
    'layer_6': 0.09298739319126932, 
    'layer_5': 0.12373674588665369, 
    'layer_4': 0.13079083051859508, 
    'layer_3': 0.18489702454666287, 
    'layer_2': 0.18938213264580353, 
    'layer_1': 0.1754568063096773, 
}

i_density_per_cubic_micron = {
    'white_matter': 0.010817226791650505, 
    'layer_6': 0.029054243819847773, 
    'layer_5': 0.03461512324513679, 
    'layer_4': 0.03805697006401235, 
    'layer_3': 0.05191007259571446, 
    'layer_2': 0.0742208288808065, 
    'layer_1': 0.09318132252821636, 
}

total_density_per_cubic_micron = {
    'white_matter': 0.04159840230007103, 
    'layer_6': 0.12204163701111709, 
    'layer_5': 0.15835186913179047, 
    'layer_4': 0.16884780058260745, 
    'layer_3': 0.23680709714237733, 
    'layer_2': 0.26360296152661006, 
    'layer_1': 0.2686381288378937, 
}

percentage_e_per_layer = {
...
if __name__ == '__main__':
    ...
    columns = [
        ...
        'layer_2_pyr_vs_int_tvalue',
        'layer_2_pyr_vs_int_pvalue',
        ...
        'layer_3_pyr_vs_int_tvalue',
        'layer_3_pyr_vs_int_pvalue',
        ...
        'layer_4_pyr_vs_int_tvalue',
        'layer_4_pyr_vs_int_pvalue',
        ...
        'layer_5_pyr_vs_int_tvalue',
        'layer_5_pyr_vs_int_pvalue',
        ...
        'layer_6_pyr_vs_int_tvalue',
        'layer_6_pyr_vs_int_pvalue',
        ...
        'white_matter_pyr_vs_int_tvalue',
        'white_matter_pyr_vs_int_pvalue',
    ]
    ...
    for syn_cort_layer in ['all_inputs'] + all_layers:
        ...
        assert len(data_this_syn_cort_layer) == 57
